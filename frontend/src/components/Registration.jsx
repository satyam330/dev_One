...
const Registration = () => {
  ...
  return (
    <div className="flex justify-center items-center min-h-screen bg-gradient-to-br from-indigo-600 to-blue-300 p-4">
      <div className="bg-white bg-opacity-10 backdrop-blur-lg shadow-xl rounded-lg w-full max-w-lg p-8">
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div className="text-center">
            <button
              type="submit"
              className="w-full bg-gradient-to-r from-pink-500 to-indigo-600 text-gray px-4 py-3 rounded-lg font-semibold shadow-md transform transition-transform hover:scale-105 hover:shadow-xl"
            >
              Register 🚀
            </button>
          </div>
