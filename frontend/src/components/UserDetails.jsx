...
const UserDetails = () => {
  ...
  return (
    <div className="flex justify-center items-center min-h-screen bg-gradient-to-br from-indigo-700 to-blue-200 p-4">
      <div className="bg-white bg-opacity-10 backdrop-blur-lg shadow-xl rounded-lg w-full max-w-4xl p-8">
        <h2 className="text-2xl sm:text-3xl font-bold text-center text-gray-500 mb-6">🚀 User List</h2>
